...
#include <locale.h> // biblioteca de alocação de texto por regiaão
...

{
   ...
   printf("Digite o CPF a ser cadastrado:  ");  // coleta informções do usuário
	...
	switch(opcao)
{
	...
	default:
	printf("Essa opção não está disponovel!\n");
	  system("pause");
      break;
       // fim da seleção
      }
